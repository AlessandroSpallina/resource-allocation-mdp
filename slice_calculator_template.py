# see https://github.com/HankerZheng/Basic-Calculator-for-Queueing-Theory/blob/master/MMcQueue.py
...
if __name__ == '__main__':
    thisQueue = SliceCalculator(2, 3, 2)
    queueTime = 0.001
